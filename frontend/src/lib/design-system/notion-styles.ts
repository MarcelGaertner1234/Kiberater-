...
export const notionStyles = {
  ...
  input: {
    ...
    label: 'block text-notion-sm font-medium mb-1 text-notion-text dark:text-notion-dark-text',
  ...
  text: {
    ...
    lead: 'text-notion-lg text-notion-text-secondary dark:text-notion-dark-text-secondary leading-relaxed',
