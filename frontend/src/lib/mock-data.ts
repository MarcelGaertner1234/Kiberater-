...
export const mockChatMessages = [
  {
    ...
    message: 'Hallo John! Wie läuft das Customer Service Bot Projekt? Haben Sie noch Fragen zur aktuellen Implementation?',
  ...
  },
  {
    ...
    senderName: 'John Doe',
    senderRole: 'Kunde',
    message: 'Hi Maria! Das Projekt läuft gut. Ich hätte eine Frage zur Integration mit unserem bestehenden CRM-System. Können wir das diese Woche besprechen?',
  ...
  },
  {
    ...
    senderName: 'Maria Schmidt',
    senderRole: 'Senior KI-Beraterin',
    message: 'Absolut! Ich habe Donnerstag um 14:00 Zeit. Soll ich einen Termin in Ihren Kalender eintragen? Wir können auch gerne einen Bildschirm teilen für die technischen Details.',
