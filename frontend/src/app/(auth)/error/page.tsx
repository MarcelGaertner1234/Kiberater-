...
const errorMessages: Record<string, string> = {
  ...
  OAuthAccountNotLinked:
    'Um die Sicherheit zu gewährleisten, verwenden Sie den gleichen Anbieter, mit dem Sie sich ursprünglich angemeldet haben.',
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className={styles.text('body')}>Beim Anmelden ist ein Problem aufgetreten</p>
      </div>

      <NotionCard padding="lg" className="space-y-4">
        <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md">
          <h3 className="font-medium text-red-800 dark:text-red-200 mb-2">Fehlerdetails</h3>
      ...
      <div className="text-center">
        <p className={styles.text('body')}>
          Brauchen Sie Hilfe?{' '}
          <Link href="/support" className="text-notion-blue hover:underline font-medium">
