                                    ...
                                    <div className="space-y-3">
                                      ...
                                      <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                          <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-${getPriorityColor(task.priority)}/10 text-${getPriorityColor(task.priority)}`}>
                                        ...
                                        <div className="flex items-center gap-2">
                                          ...
                                          <div className="flex -space-x-1">
                                            {task.assignees.map((assignee, i) => (
                                              <div key={i} className="w-6 h-6 rounded-full bg-gradient-to-br from-notion-blue to-notion-purple flex items-center justify-center text-white text-xs font-medium border-2 border-notion-bg dark:border-notion-dark-bg">
                                                {assignee}
                                              </div>
                                            ))}
                                          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredTasks.map((task) => {
                  ...
                  return (
                    <tr key={task.id} className="border-b border-notion-border dark:border-notion-dark-border hover:bg-notion-bg-hover dark:hover:bg-notion-dark-bg-hover transition-colors">
