  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className={styles.text('body')}>Starten Sie Ihre KI-Beratung heute</p>
      </div>
      ...
      <NotionCard padding="lg" className="space-y-6">
        ...
        <form onSubmit={handleSubmit(handleRegister)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select {...register('companySize')} id="companySize" className={styles.input()}>
      ...
      <div className="text-center">
        <p className={styles.text('body')}>
          Bereits ein Konto?{' '}
          <Link href="/auth/login" className="text-notion-blue hover:underline font-medium">
            Jetzt anmelden
          </Link>
        </p>
      </div>
