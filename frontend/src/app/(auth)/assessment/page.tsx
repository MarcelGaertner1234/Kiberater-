  ...
  return (
    <NotionCard className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className={styles.text('h2', 'mb-2')}>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {errors.industry && (
            <p className="text-notion-red text-xs mt-1">{errors.industry}</p>
          )}
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            {companySizes.map((size) => (
              <label key={size.value} className="flex items-center p-3 border border-notion-border dark:border-notion-dark-border rounded-lg hover:bg-notion-bg-hover dark:hover:bg-notion-dark-bg-hover cursor-pointer transition-colors">
                <input
                  type="radio"
                  name="companySize"
                  value={size.value}
        ...
        <div>
          ...
          {errors.revenue && (
            <p className="text-notion-red text-xs mt-1">{errors.revenue}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.role && (
            <p className="text-notion-red text-xs mt-1">{errors.role}</p>
          )}
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-xs text-notion-text-secondary dark:text-notion-dark-text-secondary">
              Ihre Unternehmensdaten helfen uns, branchenspezifische KI-Anwendungsfälle zu identifizieren 
              und realistische ROI-Prognosen zu erstellen. Alle Daten werden vertraulich behandelt.
            </p>
          </div>
        </div>
      </div>
