        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            className={styles.text(
              'h1',
              'mb-6 text-4xl lg:text-6xl bg-gradient-to-r from-notion-text via-notion-blue to-notion-purple bg-clip-text text-transparent'
            )}
          >
          ...
          <p className="text-xl text-notion-text-secondary dark:text-notion-dark-text-secondary mb-8 max-w-2xl mx-auto leading-relaxed">
            Personalisierte Beratung, praktische Umsetzung, messbare Erfolge. Wir begleiten Sie auf
            Ihrer KI-Reise - von der ersten Idee bis zur erfolgreichen Implementation.
          </p>
...
function FeaturesSection() {
  const features = [
    {
      ...
      title: 'KI-Assessment',
      description:
        'Detaillierte Analyse Ihres Unternehmens und maßgeschneiderte KI-Empfehlungen für optimale Ergebnisse.',
      color: 'notion-blue',
    },
    {
      ...
      description:
        'Schritt-für-Schritt Plan zur KI-Implementation mit klaren Meilensteinen und messbaren Zielen.',
      color: 'notion-purple',
    },
    {
  ...
  return (
    <section
      id="features"
      className="py-20 bg-notion-bg-secondary dark:bg-notion-dark-bg-secondary"
    >
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-${feature.color}/10 text-${feature.color} mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
                {feature.icon}
              </div>
...
function HowItWorksSection() {
  const steps = [
    {
      ...
      title: 'KI-Assessment',
      description:
        'In 15 Minuten analysieren wir Ihr Unternehmen und identifizieren die besten KI-Anwendungsfälle.',
    ...
    },
    {
      ...
      description:
        'Wir erstellen Ihre personalisierte KI-Roadmap mit konkreten Schritten und Zeitplänen.',
    ...
    },
    {
      ...
      description:
        'Schritt-für-Schritt begleiten wir Sie bei der Umsetzung - von der Technologie bis zum Change Management.',
    ...
    },
    {
      ...
      description:
        'Kontinuierliches Monitoring und Optimierung für maximalen ROI und nachhaltigen Erfolg.',
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">Wie wir Ihnen helfen</h2>
          <p className="text-xl text-notion-text-secondary dark:text-notion-dark-text-secondary max-w-2xl mx-auto">
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        'Die KI-Beratung hat unser Unternehmen transformiert. ROI von 300% innerhalb von 6 Monaten.',
    ...
    {
      quote:
        'Endlich KI, die wirklich funktioniert. Das Team versteht unsere Branche und liefert Ergebnisse.',
      author: 'Thomas Weber',
    ...
    {
      quote:
        'Von der ersten Analyse bis zur Implementation - alles war professionell und effizient.',
      author: 'Anna Müller',
      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-notion-text-secondary dark:text-notion-dark-text-secondary mb-8">
            Starten Sie heute mit Ihrer kostenlosen KI-Analyse und entdecken Sie das Potenzial für
            Ihr Unternehmen.
          </p>
