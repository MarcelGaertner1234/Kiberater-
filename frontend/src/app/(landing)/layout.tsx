        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-notion-text-secondary dark:text-notion-dark-text-secondary">
              <li><Link href="#features" className="hover:text-notion-text dark:hover:text-notion-dark-text">Features</Link></li>
              <li><Link href="#pricing" className="hover:text-notion-text dark:hover:text-notion-dark-text">Preise</Link></li>
              <li><Link href="/demo" className="hover:text-notion-text dark:hover:text-notion-dark-text">Demo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-notion-text-secondary dark:text-notion-dark-text-secondary">
              <li><Link href="/about" className="hover:text-notion-text dark:hover:text-notion-dark-text">Über uns</Link></li>
              <li><Link href="/blog" className="hover:text-notion-text dark:hover:text-notion-dark-text">Blog</Link></li>
              <li><Link href="/contact" className="hover:text-notion-text dark:hover:text-notion-dark-text">Kontakt</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-notion-text-secondary dark:text-notion-dark-text-secondary">
              <li><Link href="/privacy" className="hover:text-notion-text dark:hover:text-notion-dark-text">Datenschutz</Link></li>
              <li><Link href="/terms" className="hover:text-notion-text dark:hover:text-notion-dark-text">AGB</Link></li>
              <li><Link href="/imprint" className="hover:text-notion-text dark:hover:text-notion-dark-text">Impressum</Link></li>
            </ul>
          </div>
        </div>
